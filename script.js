class Drink{
   ...
   let avocadoMargarita = new Drink("Avocado Margarita", "Coupe Glass", "Tajin Chile Lime Salt", ["Don Julio Anejo 1.5 oz"], "Cointreau .5 oz", ["Avocado Sour Mix 3 oz,", "Lime Juice .75 oz"], ["Lime Wheel"],"./images/margarita.jpg");
   ...
   let cocorita = new Drink("CocoRita", "Coupe Glass", "Coconut Powder", ["1800 Coconut 1.5 oz"], "Combier Orange", ["Coconut Puree 1 oz,", "Lime Juice .5 oz,", "Pineapple Juice .5 oz"], ["Lime Wheel"],"./images/margarita.jpg");
   ...
   let floridaGrovePunch = new Drink("Florida Grove Punch", "Pineapple Glass", "Tajin Chile Lime Salt", ["Pueblo Viejo Blanco 1.5 oz"], "None", ["Agave .75 oz,", "Cucumber (3 Slices Muddled),", "Lime Juice .5 oz,", "Watermelon Juice 1.5 oz"], ["Pineapple Wedge and Leaf"],"./images/margarita.jpg");
   let floridaGrovePunchFB = new Drink("Florida Grove Punch (Fish Bowl)", "Fish Bowl", "Tajin Chile Lime Salt", ["Pueblo Viejo Blanco 6 oz"], "None", ["Agave 2.25 oz,", "Cucumber (6 Slices Muddled),", "Lime Juice 1.5 oz,", "Watermelon Juice 6 oz"], ["Pineapple Wedge and Leaf"],"./images/margarita.jpg");
   ...
   let juanCollins = new Drink("Juan Collins", "Rocks Glass", "None", ["El Jimador Reposado 1.5 oz"], "None", ["Agave .5 oz,", "Lemon Juice .5 oz,", "Topo Chico"], ["Lemon Twist"], "./images/margarita.jpg")
   ...
   //let michelada = new Drink("Michelada", "Beer Mug", "Tajin Chile Lime Salt", ["None"], "None", ["Dos Equis,", "Michelada Mix 5 oz"], ["Lime Wheel"],"./images/margarita.jpg");
   ...
   let naturita = new Drink("Naturita", "Hurricane Glass", "Guest Choice", ["Altos Blanco 2 oz"], "None", ["Agave 1 oz,", "Happy Juice 2 oz"], ["Lime Wheel"],"./images/margarita.jpg");
   let oaxacanOldFashioned = new Drink("Oaxacan Old Fashioned", "Rocks Glass", "None", ["Altos Reposado 1.5 oz,", "Los Vecinos Espadin Mezcal .5 oz"], "None", ["Agave .25 oz,", "Angostura Bitters (2 Dashes)"], ["Flamed Orange Peel"],"./images/margarita.jpg");
   ...
   let paloma = new Drink("Paloma", "Rocks Glass", "None", ["Altos Blanco 1.5 oz"], "None", ["Agave .5 oz,", "Grapefruit Soda 3 oz,", "Lime Juice .25 oz"], ["Lime Wheel"],"./images/margarita.jpg");
   ...
   //let sangria = new Drink("Sangria", "Wine Glass", "None", ["St. George California Citrus Vodka .75 oz"], "None", ["Agave .5 oz,", "Blackberry (3 Muddled),", "Lemon (1 Slice Muddled),", "Lolailo Sangria 4 oz,", "Orange (1 Slice Muddled)"], ["Blackberry and Orange Slice (Flag)"],"./images/margarita.jpg");
   let sangria = new Drink("Sangria", "Mason Jar", "None", ["Sangria Mix (Half Glass w/ Ice)"], "None", ["Ginger Ale"], ["Blackberry and Orange Slice (Flag)"],"./images/margarita.jpg");
   let skinnyOrganic = new Drink("Skinny Organic", "Hurricane Glass", "Guest Choice", ["Azunia Blanco 2 oz"], "None", ["Agave 1 oz,", "Lime Juice 1.5 oz"], ["Lime Wheel"],"./images/margarita.jpg");
   //let spicyBerryFresca = new Drink("Spicy Berry Fresca", "Rocks Glass", "None", ["Dulce Vida Pineapple 1.5 oz"], "None", ["Grapefruit Soda 3 oz,", "Jalapeno (1 Slice Muddled),", "Lime Juice .5 oz,", "Strawberry Puree .75 oz"], ["Jalapeno (Slice),", "Strawberry (Slice)"],"./images/margarita.jpg");
   let spicyWatermelonMargarita = new Drink("Spicy Watermelon Margarita", "Margarita Glass", "Guest Choice", ["Tanteo Habanero 2 oz"], "None", ["Agave .75 oz,", "Lime Juice .5 oz,", "Watermelon Juice 1.5 oz"], ["Watermelon Chunks"], "./images/margarita.jpg")
   let tequilaSour = new Drink("Tequila Sour", "Coupe Glass", "None", ["Tanteo Chipotle 2 oz"], "None", ["Agave .75 oz,", "Egg Whites 1.5 oz,", "Lime Juice 1.25 oz"], ["Angostura Bitters (Stencil),", "Lime Twist"], "./images/margarita.jpg")
   ...
   let tntRumRunner = new Drink("T&T Rum Runner", "Pineapple Glass", "None", ["Papas Pilar Anejo 1.25 oz,", "Club Caribe Banana Rum 1 oz"], "None",["Guava Puree .5 oz,", "Lime Juice 1 oz,", "Pineapple Juice 1 oz"], ["Dark Rum (Float),", "Pineapple Wedge and Leaf"],"./images/margarita.jpg");
   let tntRumRunnerFB = new Drink("T&T Rum Runner (Fish Bowl)", "Fish Bowl", "None", ["Papas Pilar Anejo 1.25 oz 3.75 oz,", "Club Caribe Banana Rum 3 oz"], "None", ["Guava Puree 1.5 oz,", "Lime Juice 2.25 oz,", "Pineapple Juice 2.25 oz"], ["Dark Rum (Float),", "Pineapple Wedge and Leaf"],"./images/margarita.jpg");
