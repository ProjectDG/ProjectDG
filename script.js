class Drink{
   ...
   let juanCollins = new Drink("Juan Collins", "Rocks Glass", ["El Jimador Reposado 1.5 oz"], "None", ["Agave .5 oz,", "Lemon Juice .5 oz,", "Topo Chico"], ["Lemon Twist"], "./images/.jpg")
   ...
   let spicyWatermelonMargarita = new Drink("Spicy Watermelon Margarita", "Margarita",["Tanteo Habanero 2 oz"], "None", ["Agave .75 oz,", "Lime Juice .5 oz,", "Watermelon Juice 1.5 oz"], ["Watermelon Chunks"], "./images/.jpg")
   let tequilaSour = new Drink("Tequila Sour", "Coupe Glass", ["Tanteo Chipotle 2 oz"], "None", ["Agave .75 oz,", "Egg Whites 1.5 oz,", "Lime Juice 1.25 oz"], ["Angostura Bitters,", "Lime Twist"], "./images/.jpg")
...
$(document).ready(function(){
    ...
    $('body').on('click','.all-buttons', '.result-item', function(){
        ...
        $(".form-container").hide();
        $(".results-list").hide();
        //$(".item3").fadeIn(200);  dont forget to uncomment once all pics are entered !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        $(".item4").fadeIn(200);
