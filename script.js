class Drink{
   ...
   let mexicanBullDog = new Drink("Mexican Bull Dog", "Rocks Glass", "None", ["1800 Reposado 1 oz,", "St. George Nola Coffee Vodka 1.5 oz"], null, [ "Cola (Splash),", "Cream (Float)"], ["None"],"./images/margarita.jpg");
   ...
   let pacificMule = new Drink("Pacific Mule", "Copper Mug", "None", ["St. George Green Chili Vodka 1.5 oz"], null, ["Agave .25 oz,", "Cucumber (1 Slice Muddled),", "Ginger Beer 4 oz,", "Lime Juice .25 oz"], ["Cucumber Slice (Length)"],"./images/margarita.jpg");
   ...
   let sangria = new Drink("Sangria", "Mason Jar", "None", "None", null, ["Ginger Ale,", "Sangria Mix (Half Glass w/ Ice)"], ["Blackberry and Orange Slice (Flag)"],"./images/margarita.jpg");
   //fix "liqor"  label  ^^^^  
